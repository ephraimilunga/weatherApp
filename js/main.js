...
function erroMessage() {
    ...
    <div class="loader_container">
      <div class="loader_title" style="text-align: center">
           Oops! Your browser doesn't allow insecure connection.
      </div>
      <div class="loader_title" style="font-size: 25px; margin: 10px 0 60px 0; letter-spacing: 0.6px; text-align: center">
        To use eWeather, please make sure you have enabled connexion via HTTP (not safe). Note: This is due to a free API using HTTP connexion rather than HTTPs. You'are safe :)
      </div>
  </div>
  `;
}
...
async function handleFetchWeatherData(obj) {
    ...
    // fetch the user city
    const city = await fetch(`${corsApiUrl}http://getcitydetails.geobytes.com/GetCityDetails?fqcn=${ip.ip}`)
        .then(result => result.json())
        .then(data => data)
        .catch(e => {
            loaderContainer.innerHTML = erroMessage();
    ...
    const endPoint = `${weatherLink}key=${weather}&city=${city.geobytescity}&lang=${language}&unit=${unit}&days=${days}`;
    weatherData = await fetch(endPoint)
        .then(result => result.json())
        .then(data => data)
        .catch(e => {
            loaderContainer.innerHTML = erroMessage();
    ...
    <!--start today-provision-->
      ...
      <div class="today_status_feature">
          ...
          <div class="today_max_temp">
              ...
              <div class="today_max_temp_icon"><img src="https://ephraimilunga.co.za/eweather/icons/max_temp_on_yellow.svg" alt="iweather"></div>
          ...
          <div class="today_min_temp">
              <!--start today min-temp -->
              <div class="today_min_temp_icon"><img src="https://ephraimilunga.co.za/eweather/icons/min_temp_on_yellow.svg" alt="iweather"></div>
          ...
          <div class="today_cloud_percent">
              <!--start today min-temp -->
              <div class="today_cloud_percent_icon"><img src="https://ephraimilunga.co.za/eweather/icons/cloud_percent_on_yellow.svg" alt="iweather"></div>
    ...
    tomorrowContainer.innerHTML = `
                    ...
                    <div class="tomorrow_right_section">
                        ...
                        <div class="tomorrow_max_min_temp_cloud">
                            ...
                            <div class="tomorrow_max_temp">
                                <div class="tomorrow_max_icon"><img src="https://ephraimilunga.co.za/eweather/icons/max_temp_gray.svg" alt=""></div>
        ...
        defaultParameters.unit
                            ...
                            <div class="tomorrow_min_temp">
                                <div class="tomorrow_min_icon"><img src="https://ephraimilunga.co.za/eweather/icons/min_temp_gray.svg" alt=""></div>
        ...
        defaultParameters.unit
                            ...
                            <div class="tomorrow_cloud">
                                <div class="tomorrow_cloud_icon"><img src="https://ephraimilunga.co.za/eweather//icons/cloud_gray.svg" alt=""></div>
...
function displaySingleView() {
    ...
    <div class="fadeInTheSingle single_view_panel_content">
                <div class="weather_single_close">
                    <img class="closeSingleView" src="https://ephraimilunga.co.za/eweather//icons/singleview/close.svg" alt="">
                </div>
                ...
                <div class="weather_single_city_country">
                    <img src="https://ephraimilunga.co.za/eweather//icons/singleview/location.svg" alt="">
                ...
                <div class="glide weahter_more_info_arrows_container">
                    <div class="weahter_more_info_arrows">
                        ...
                        <div class="weather_single_arrows glide__arrows" data-glide-el="controls">
                            <img src="https://ephraimilunga.co.za/eweather//icons/singleview/arrow_left.svg" class="eLeft glide__arrow glide__arrow--left" data-glide-dir="<">
                            <img src="https://ephraimilunga.co.za/eweather//icons/singleview/arrow_right.svg" class="eRight glide__arrow glide__arrow--right" data-glide-dir=">">
                        </div>
                    </div>
                        ...
                        <div class="weather_slider_block_content glide__slides">
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="temp" src="https://ephraimilunga.co.za/eweather//icons/singleview/thermometer1.svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="clouds" src="https://ephraimilunga.co.za/eweather//icons/singleview/cloud.svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="snow" src="https://ephraimilunga.co.za/eweather//icons/singleview/snowflake(1).svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="humidity" src="https://ephraimilunga.co.za/eweather//icons/singleview/binoculars.svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="precipitation" src="https://ephraimilunga.co.za/eweather//icons/singleview/precipitation(1).svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="wind" src="https://ephraimilunga.co.za/eweather//icons/singleview/wind.svg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img class="sun" src="https://ephraimilunga.co.za/eweather//icons/singleview/sunset.svg" alt="">
                                </div>
                            </div>
                            ...
                            <!-- <div class="glide__slide">
                                ...
                                <div class="weather_single_icon">
                                    <img src="https://ephraimilunga.co.za/eweather//icons/singleview/binoculars.svg" alt="">
                                </div>
                            </div> -->
